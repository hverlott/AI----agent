...
@pytest.mark.asyncio
async def test_platform_toggle():
    ...
    # When audit is disabled via toggle, it might skip audit steps or treat as pass. 
    # Logic in AuditManager needs to be checked if "audit_primary_passed" is True when skipped.
    # Assuming the original test assertion was correct:
