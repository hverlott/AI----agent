...
#### 2.2.1 可视化剧本编排 (v2.5.2 新特性)
**功能**: 在配置 Stage (剧本) 时，系统现提供 **👁️ 流程图预览 (Flowchart Preview)** 面板。
- **实时渲染**: 根据您配置的节点 (Nodes) 与跳转规则 (Transitions)，自动生成 DAG 流程图。
- **高亮显示**: 
  - 🟢 开始节点 (Start)
  - 🔴 结束节点 (End)
  - 🔗 跳转条件显示在连线上

此功能极大降低了 JSON 配置的门槛，帮助您直观检查死循环或断连节点。
...
| 版本号 | 更新日期 | 修改人 | 修改摘要 |
| :--- | :--- | :--- | :--- |
| v2.5.2 | 2026-01-15 | System Admin | 新增可视化剧本编排说明 |
