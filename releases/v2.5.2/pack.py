...
def pack_project():
    ...
    # Read version from admin_multi.py
    try:
        with open('admin_multi.py', 'r', encoding='utf-8') as f:
            for line in f:
    ...
    pkg_name = f"SaaS-AI-System-v{app_version}"
    ...
    # 3. Directories
    dirs_to_copy = ['platforms', 'docs', 'data', 'tools', 'tests', '.streamlit', 'src', 'scripts']
...
# 内容过滤配置 (JSON)
CONTENT_FILTER={"enabled": false, "rules": []}
"""
...
"""
    ...
    files_to_clean = {
        ...
        "data/core.db": None,
        ".env": None,
        # "scripts/migrate_to_db.py": None, # Exclude dev scripts - KEEP THIS for upgrade!
        # "tests/regression_suite_v2_5_2.py": None # KEEP THIS for verification!
    }
