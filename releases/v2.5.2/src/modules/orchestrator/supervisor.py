...
class SupervisorAgent:
    def __init__(self, tenant_id: str, policy: Dict[str, Any] | None = None):
        self.tenant_id = tenant_id
        self.policy = policy or {}

    async def decide(self, state: Dict[str, Any], recent_dialog: List[Dict[str, Any]], ai_client=None, model_name: str = None) -> Dict[str, Any]:
