...
class StageAgentRuntime:
    ...
    def _load_binding_json(self) -> Dict:
        ...
        try:
            ...
            return {}
    def get_stage_profile(self, stage_name: str) -> Dict:
    ...
    def build_system_prompt(self, state: Dict, base_system_prompt: str, kb_items: List[Dict]) -> str:
        ...
        # 4. KB Injection (if not already handled by main.py, but main.py handles it. 
        # However, main.py's handling is simple. Let's rely on main.py for KB for now to avoid duplication 
        # OR we assume main.py passes a base prompt that DOES NOT have KB, and we add it here.
        # Looking at main.py, it constructs `system_with_kb` before calling this. 
        # So we should treat `base_system_prompt` as potentially containing KB.)
